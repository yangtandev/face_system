...
if [ -d "./site-packages" ]; then
    cp -r ./site-packages /home/$USER_NAME/face_system/venv/lib/python3.10/
    echo "複製python套件"
else
    source "/home/$USER_NAME/face_system/venv/bin/activate"
...
sudo chmod 775 /home/$USER_NAME/face_system/venv -R
sudo chown $USER_NAME /home/$USER_NAME/face_system -R
sudo chown $USER_NAME /home/$USER_NAME/face_system/venv -R
...
# 在用戶主目錄下創建 face_sys.desktop 文件
echo "$DESKTOP_ENTRY" > /home/$USER_NAME/face_sys.desktop
sudo chmod 644 /home/$USER_NAME/face_sys.desktop
# 移動 face_sys.desktop 到 /usr/share/applications 資料夾
sudo cp /home/$USER_NAME/face_sys.desktop /usr/share/applications/
sudo cp /home/$USER_NAME/face_sys.desktop /home/$USER_NAME/.config/autostart/
sudo cp /home/$USER_NAME/face_sys.desktop /home/$USER_NAME/.config/autostart/
# 設置正確的權限
sudo chmod 644 /usr/share/applications/face_sys.desktop
